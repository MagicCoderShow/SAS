...
<html lang="en">
	<head>
		...
		<!--[if IE 7]>
		  <link rel="stylesheet" href="aceadmin/assets/css/font-awesome-ie7.min.css" />
		<![endif]-->
		...
		<!--[if lt IE 9]>
		<script src="aceadmin/assets/js/html5shiv.js"></script>
		<script src="aceadmin/assets/js/respond.min.js"></script>
		<![endif]-->
	</head>
	...
	the lightweight, feature-rich and easy to use admin template.
														...
														<div id="member-tab" class="tab-pane">
															<div class="clearfix">
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="aceadmin/assets/avatars/user.jpg" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Joe Doe's avatar" src="aceadmin/assets/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Jim Doe's avatar" src="aceadmin/assets/avatars/avatar.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alex Doe's avatar" src="aceadmin/assets/avatars/avatar5.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Bob Doe's avatar" src="aceadmin/assets/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Susan's avatar" src="aceadmin/assets/avatars/avatar3.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Phil Doe's avatar" src="aceadmin/assets/avatars/avatar4.png" />
																	</div>
																...
																<div class="itemdiv memberdiv">
																	<div class="user">
																		<img alt="Alexa Doe's avatar" src="aceadmin/assets/avatars/avatar1.png" />
																	</div>
														...
														<div id="comment-tab" class="tab-pane">
															<div class="comments">
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Bob Doe's Avatar" src="aceadmin/assets/avatars/avatar.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Jennifer's Avatar" src="aceadmin/assets/avatars/avatar1.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Joe's Avatar" src="aceadmin/assets/avatars/avatar2.png" />
																	</div>
																...
																<div class="itemdiv commentdiv">
																	<div class="user">
																		<img alt="Rita's Avatar" src="aceadmin/assets/avatars/avatar3.png" />
																	</div>
												...
												<div class="widget-main no-padding">
													<div class="dialogs">
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Alexa's Avatar" src="aceadmin/assets/avatars/avatar1.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="John's Avatar" src="aceadmin/assets/avatars/avatar.png" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Bob's Avatar" src="aceadmin/assets/avatars/user.jpg" />
															</div>
														...
														<div class="itemdiv dialogdiv">
															<div class="user">
																<img alt="Jim's Avatar" src="aceadmin/assets/avatars/avatar4.png" />
															</div>
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='aceadmin/assets/js/jquery-1.10.2.min.js'>"+"<"+"/script>");
</script>
<![endif]-->

		<script type="text/javascript">
			if("ontouchend" in document) document.write("<script src='aceadmin/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
		<script src="aceadmin/assets/js/bootstrap.min.js"></script>
		<script src="aceadmin/assets/js/typeahead-bs2.min.js"></script>

		<!-- page specific plugin scripts -->

		<!--[if lte IE 8]>
		  <script src="aceadmin/assets/js/excanvas.min.js"></script>
		<![endif]-->

		<script src="aceadmin/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
		<script src="aceadmin/assets/js/jquery.ui.touch-punch.min.js"></script>
		<script src="aceadmin/assets/js/jquery.slimscroll.min.js"></script>
		<script src="aceadmin/assets/js/jquery.easy-pie-chart.min.js"></script>
